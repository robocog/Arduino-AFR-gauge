...
//convert pin value to volts (0=0v rich, 1024=5v lean)
input_voltage = (analog_value * 5) / 1024.0;

//convert input voltage to AFR reading  (0v=10afr- rich, 5v=20afr-lean)
afr= ((input_voltage / 0.5)+10);

//convert something ...afr this time...to gauge scaling (rich max=60, stoich=30, lean min=0)
//alternately to scale top of optimal as 12.5 and lower optimal as 15...
//gauge = ((afr - 10)/(18-10))*(1-50)+50;
//new_value = ((old_value - old_min) / (old_max - old_min) ) * (new_max - new_min) + new_min
//old style gauge= ((afr - 10)/(20-10))*(1-50)+50;
//new dac controlled gauge...
gauge = ((afr - 10)/(20-10))*(0-4095)+4095;

//Send raw pin value volts and AFR to serial output 
Serial.print("Pin= ");
